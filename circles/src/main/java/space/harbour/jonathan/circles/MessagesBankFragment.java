...
public class MessagesBankFragment extends Fragment {
    ...
    public MessagesBankFragment setCircle(String circle) {
        this.circle = circle;
        return this;
    }
    ...
    public void refreshMessages() {
        messages.clear();
        messages.addAll(((MainActivity) getActivity()).getDataManager().getCircleMessages(circle));
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        messages = ((MainActivity) getActivity()).getDataManager().getCircleMessages(circle);
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                boolean success = ((MainActivity) getActivity()).getDataManager().addMessageToCircle(newMsg, circle);
                if (!success) {
        ...
        msgListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                String removed = ((MainActivity) getActivity()).getDataManager().removeMessageFromCircle(i, circle);
